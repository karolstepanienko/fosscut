...
public class Greedy {
    ...
    @Test public void greedyRelaxCost0QuietSavePlanToFile() throws IOException {
        ...
        Command command = new Command("greedy -q -c 0 -r -o " + testFileName + " " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_ORDER));
        command.run();
        assert(command.getOutput().equals(""));
        assertEquals(
            Utils.loadFile(TestDefaults.FOSSCUT_BINARY_FOLDER_PATH + File.separator + testFileName),
    ...
    @Test public void greedyRelaxCost1QuietSavePlanToFile() throws IOException {
        ...
        Command command = new Command("greedy -q -c 1 -r -o " + testFileName + " " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_ORDER));
        command.run();
        assert(command.getOutput().equals(""));
        assertEquals(
            Utils.loadFile(TestDefaults.FOSSCUT_BINARY_FOLDER_PATH + File.separator + testFileName),
    ...
    @Test public void greedyIntegerRelaxCost0QuietSavePlanToFile() throws IOException {
        ...
        Command command = new Command("greedy -q -c 0 -r -i -o " + testFileName + " " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_ORDER));
        command.run();
        assert(command.getOutput().equals(""));
        assertEquals(
            Utils.loadFile(TestDefaults.FOSSCUT_BINARY_FOLDER_PATH + File.separator + testFileName),
    ...
    @Test public void greedyCost() throws IOException {
        ...
        Command command = new Command("greedy -q --optimization-criterion MIN_COST -o " + testFileName + " " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_INPUT_COST_ORDER));
        command.run();
        assert(command.getOutput().equals(""));
        assertEquals(
            Utils.loadFile(TestDefaults.FOSSCUT_BINARY_FOLDER_PATH + File.separator + testFileName),
    ...
    @Test public void greedyNullCostException() {
        Command command = new Command("greedy --optimization-criterion MIN_COST " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_ORDER));
        command.run();
    ...
    @Test public void greedyNullCostExceptionQuiet() {
        Command command = new Command("greedy -q --optimization-criterion MIN_COST " + Utils.getAbsolutePath(TestDefaults.EXAMPLE_ORDER));
        command.run();
