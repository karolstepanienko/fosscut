...
public class CgCompareSolverLinPDLPIntCBCOptimalgen10itTest extends CgCompareSolverOptimalgen10itPlot {

    private static String testName = "cgCompareSolverLinPDLPIntCBCOptimalgen10itTest";
    protected static String planCommand = "cg --linear-solver PDLP --integer-solver CBC -ln 1 -in 1 --timeout-amount 5 --timeout-unit MINUTES";
    private static String cpu = "1";
    private static String memory = "6Gi"; // MEMORY SETTING READY

    /***************************** Results Report *****************************/

    @Test @Order(2) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itResultsReport() {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx50() throws InterruptedException {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx160() throws InterruptedException {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx170() throws InterruptedException {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx180() throws InterruptedException {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx190() throws InterruptedException {
    ...
    @Test @Order(1) public void cgCompareSolverLinPDLPIntCBCOptimalgen10itx200() throws InterruptedException {
